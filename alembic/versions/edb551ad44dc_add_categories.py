...
Revision ID: edb551ad44dc
Revises: 789953bf9c87
Create Date: 2025-09-19 15:16:58.309347
...
def upgrade() -> None:
    ...
    op.alter_column('found_items', 'description',
               ...
               nullable=False)
    op.add_column('lost_items', sa.Column('category_id', sa.Integer(), nullable=False))
